...
@{Network_Excel_files}           ha_vshaken.xlsm      unused_vshaken.xlsm   
@{Vnf_Excel_files}       vnf_vshaken.xlsm 
@{vf_preload_files}    updated_VSHAKEN_ssa_b_trial.xlsm     
...
TC#1_Network_Model_Creation
                               ...
                               Set VNF Variable     VSHAKEN
                               Log To Console       VNF model is set for VSHAKEN
                               ${NumModelsCount}    Evaluate                        ${VSHAKEN_NumModels}+1
...
TC#5_VNF_Preload_Upload
    ...
    Set Global Variable                 ${vnf}                                  VSHAKEN
    VF Preload upload                   ${vf_preload_files}    
    
    
TC#6_VNF_Spinup
    Set Global Variable    ${GLOBAL_SELENIUM_BROWSER }    firefox
    Set Global Variable    ${GLOBAL_VNF}                  VSHAKEN
    VNF Creation           vnf
