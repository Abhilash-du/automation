...
@{Network_Excel_files}           mgmt_vcom_net_95.xlsm      #GRP-27529-T-SIL-13B_MGMT_VBGW0_net_11.xlsm   GRP-27529-T-SIL-13B_TRST_VBGW0_net_11.xlsm  GRP-27529-T-SIL-13B_UNTR_VBGW0_net_11.xlsm
@{Vnf_Excel_files}       GRP_27529_T_SIL_13B_MGMT_VBGW0_net_11.xlsm    GRP_27529_T_SIL_13B_TRST_VBGW0_net_11.xlsm   GRP_27529_T_SIL_13B_UNTR_VBGW0_net_11.xlsm
@{vf_preload_files}    updated_VBGW_ssa_b_trial.xlsm      updated_VBGW_ssa_a_trial.xlsm        updated_VBGW_rtp_trial.xlsm
...
TC#1_Network_Model_Creation
                               ...
                               Set VNF Variable     VBGW
                               Log To Console       VNF model is set for VBGW
                               ${VBGW_NumModelCount}    Evaluate                        ${VBGW_NumModels}+1
                               :FOR                 ${netItr}                       IN RANGE                                        1            ${VBGW_NumModelCount}
...
TC#5_VNF_Preload_Upload
    ...
    Set Global Variable                 ${vnf}                                  VBGW
    VF Preload upload                   ${vf_preload_files}    
    
    
TC#6_VNF_Spinup
    Set Global Variable    ${GLOBAL_SELENIUM_BROWSER }    firefox
    Set Global Variable    ${GLOBAL_VNF}                  VBGW
    VNF Creation           vnf
