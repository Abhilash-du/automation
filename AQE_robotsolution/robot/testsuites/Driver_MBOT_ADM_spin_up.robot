...
${EXCEL_NAME}    mgmt_MBOT_net_95.xlsm
...
#${test}    Default
@{files1}         mgmt_MBOT.xlsm      #GRP-27529-T-SIL-13B_TRST_VISBC0_net_11.xlsm   #GRP-27529-T-SIL-13B_UNTR_VISBC0_net_11.xlsm   #GRP-27529-T-SIL-13B_MGMT_VISBC0_net_11.xlsm   GRP-27529-T-SIL-13B_TRST_VISBC0_net_11.xlsm
...
TC#01_ASDC_Network_Model_Creation
    ...
    # Sleep    15
     ...
     # Find Replace       ${EXECDIR}\\robot\\resources\\vid\\VID_DATA.robot      [\\$\\{]*vRAR_net_1_INVARIANT_UUID[${SPACE}a-zA-Z://0-9.\\-\\_\\[\\]\\=\\;\\'\\$\\{\\}]*     \$\{vRAR_net_1_INVARIANT_UUID\} ${SPACE}${SPACE}${SPACE} @{NETWORK_SERVICE_DISTRIBUTION_DETAILS}[1]
      ...
      common find replace    replacing flexware vfc    ${EXECDIR}\\robot\\resources\\vid\\VID_DATA.robot     GLOBAL_VNF}[${SPACE}a-zA-Z://0-9.-_]*   GLOBAL_VNF}${SPACE}${SPACE}${SPACE} MBOT-ADM
      common find replace    replacing flexware vfc    ${EXECDIR}\\robot\\resources\\SDC\\SDC_DATA.robot     SCN}[${SPACE}a-zA-Z://0-9.-_]*   SCN}${SPACE}${SPACE}${SPACE} MBOT-ADM
...
TC#02_Network_Preload_Upload
    ...
    Set Global Variable    ${vnf}      MBOT-ADM
