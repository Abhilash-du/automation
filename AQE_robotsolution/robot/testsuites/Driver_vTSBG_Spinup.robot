...
@{Network_Excel_files}           mgmt_vtsbg_net_95.xlsm      #GRP-27529-T-SIL-13B_MGMT_VTSBG0_net_11.xlsm   GRP-27529-T-SIL-13B_TRST_VTSBG0_net_11.xlsm  GRP-27529-T-SIL-13B_UNTR_VTSBG0_net_11.xlsm
@{Vnf_Excel_files}       GRP_27529_T_SIL_13B_MGMT_VTSBG0_net_11.xlsm    GRP_27529_T_SIL_13B_TRST_VTSBG0_net_11.xlsm   GRP_27529_T_SIL_13B_UNTR_VTSBG0_net_11.xlsm
@{vf_preload_files}    updated_VTSBG_ssa_b_trial.xlsm      updated_VTSBG_ssa_a_trial.xlsm        updated_VTSBG_rtp_trial.xlsm
${NUMBER_OF_ADDON_VF_MODULE}    1
${NUMBER_OF_VOLUME_GROUPS}    1
${VNF_SERVICE_INSTANCE_ID}    
...
TC#1_Network_Model_Creation
                               ...
                               Set VNF Variable     VTSBG
                               Log To Console       VNF model is set for VTSBG
                               ${NumModelsCount}    Evaluate                        ${VTSBG_NumModels}+1
...
TC#5_VNF_Preload_Upload
    ...
    Set Global Variable                 ${vnf}                                  VTSBG
    VF Preload upload                   ${vf_preload_files}
    
    
TC#6_VNF_Spinup
    Set Global Variable    ${GLOBAL_SELENIUM_BROWSER }    firefox
    Set Global Variable    ${GLOBAL_VNF}                  VTSBG
    VNF Creation           vnf
