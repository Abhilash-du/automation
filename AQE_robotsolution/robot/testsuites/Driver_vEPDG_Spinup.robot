...
@{Network_Excel_files}           gn_untrusted_fn_vepdg.xlsm      swu_direct_fn_vepdg.xlsm      oam_protected_vepdg.xlsm 
@{Vnf_Excel_files}      vnf_vepdg.xlsm
@{vf_preload_files}   vf_vepdg.xlsm 
...
TC#1_Network_Model_Creation
                               ...
                               Set VNF Variable     VEPDG
                               Log To Console       VNF model is set for VEPDG
                               ${NumModelsCount}    Evaluate                        ${VEPDG_NumModels}+1
...
TC#5_VNF_Preload_Upload
    ...
    Set Global Variable                 ${vnf}                                  VEPDG
    VF Preload upload                   ${vf_preload_files}    
    
    
TC#6_VNF_Spinup
    Set Global Variable    ${GLOBAL_SELENIUM_BROWSER }    firefox
    Set Global Variable    ${GLOBAL_VNF}                  VEPDG
    VNF Creation           vnf
