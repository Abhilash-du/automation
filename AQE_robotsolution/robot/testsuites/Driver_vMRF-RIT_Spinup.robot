...
@{Network_Excel_files}               imsli_mrf-rit.xlsm                     mgt_mrf-rit.xlsm  
@{Vnf_Excel_files}                   vnf_mrf-rit.xlsm
@{vf_preload_files}                  updated_VMFR-RIT_ssa_a_trial.xlsm                                                                                            updated_VMFR-RIT_rtp_trial.xlsm
...
TC#1_Network_Model_Creation
                                     ...
                                     Set VNF Variable                                             VMFR-RIT
                                     Log To Console                                               VNF model is set for VMFR-RIT
                                     ${NumModelsCount}                                            Evaluate                                                                                                                    ${VMRF-RIT_NumModels}+1
...
TC#5_VNF_Preload_Upload
                                     ...
                                     Set Global Variable                                          ${vnf}                                                                                                                      VMFR-RIT
                                     VF Preload upload                                            ${vf_preload_files}


TC#6_VNF_Spinup
                                     Set Global Variable                                          ${GLOBAL_SELENIUM_BROWSER }                                                                                                 firefox
                                     Set Global Variable                                          ${GLOBAL_VNF}                                                                                                               VMFR-RIT
                                     VNF Creation                                                 vnf
