...
${EXCEL_NAME}    oam_vMME_net_95.xlsm
#${NETWORK_NAME}    APP-C-24595-T-IST-05A_vcom_mngt_01
${files}           oam_vMME_net_95.xlsm      #GRP-27529-T-SIL-13B_MGMT_VISBC0_net_11.xlsm   GRP-27529-T-SIL-13B_TRST_VISBC0_net_11.xlsm  GRP-27529-T-SIL-13B_UNTR_VISBC0_net_11.xlsm
#${test}    Default
@{files1}         vMME_net.xlsm      #GRP-27529-T-SIL-13B_TRST_VISBC0_net_11.xlsm   #GRP-27529-T-SIL-13B_UNTR_VISBC0_net_11.xlsm   #GRP-27529-T-SIL-13B_MGMT_VISBC0_net_11.xlsm   GRP-27529-T-SIL-13B_TRST_VISBC0_net_11.xlsm
...
#    ${USERNAME} =    Common Get Username
    ...
    # Sleep    15
     ...
     common find replace    replacing flexware vfc    ${EXECDIR}\\robot\\resources\\SDC\\SDC_DATA.robot     SCN}[${SPACE}a-zA-Z://0-9.-_]*   SCN}${SPACE}${SPACE}${SPACE} vMME
...
# #    Log To Console    Service Instance ID : ${service_instance_id}
  ...
  common find replace    replacing flexware vfc    ${EXECDIR}\\robot\\resources\\vid\\VID_DATA.robot     GLOBAL_VNF}[${SPACE}a-zA-Z://0-9.-_]*   GLOBAL_VNF}${SPACE}${SPACE}${SPACE} vMME
   ${NumModelsCount}    Evaluate    ${NumModels}+1
...
#    Import VF    <<{vsp_name}>>
    ...
    Sleep    15
     ...
     @{SERVICE_DISTRIBUTION_DETAILS}    Distribute Service    ${VNF_SERVICE_NAME}
...
#    Get the VNF Preload Details    ${ExcelName}     ${vf-module-name}    ${vf-Module-model-name}    ${vnf-name}    ${vnf-type} 
    ...
    Set Global Variable    ${vnf}      vMME    
    ${TEST_STATUS}    SDNC Preload upload       vMME_vnf.xlsm     #${files1}
 ...
 TC#06_VNF_Spinup
    ...
    Set Global Variable   ${GLOBAL_VNF}        vMME
    VNF Creation    vnf
