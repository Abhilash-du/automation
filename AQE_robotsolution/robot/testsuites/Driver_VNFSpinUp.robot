...
TC#04_ASDC_VNF_Model_Creation
    ...
    set global variable      ${service_name_Run2}   SDC_RA_SVC_CTD_none_834128
...
TC#44_ASDC_VNF_Model_Creation
        ...
        # Set Global Variable  ${service_name_${SCN}}  ${service_name_Run2} 
...
TC_08_AddBase_AddonVFModule
    set global variable   ${GLOBAL_VNF}   CTD 
    Login To Ecomp Portal
    Go to specific Application in Portal Grid     &{APPNames_${GLOBAL_ENVIRONMENT}}[VID]
