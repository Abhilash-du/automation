...
@{Network_Excel_files}           mgmt_vmobt.xlsm 
@{Vnf_Excel_files}       vnf_vmobt.xlsm
@{vf_preload_files}    updated_VMOBT_ssa_b_trial.xlsm 
...
TC#1_Network_Model_Creation
                               ...
                               Set VNF Variable     VMOBT
                               Log To Console       VNF model is set for VMOBT
                               ${NumModelsCount}    Evaluate                        ${VMOBT_NumModels}+1
...
TC#5_VNF_Preload_Upload
    ...
    Set Global Variable                 ${vnf}                                  VMOBT
    VF Preload upload                   ${vf_preload_files}    
    
    
TC#6_VNF_Spinup
    Set Global Variable    ${GLOBAL_SELENIUM_BROWSER }    firefox
    Set Global Variable    ${GLOBAL_VNF}                  VMOBT
    VNF Creation           vnf
