...
Resource         ../resources/NC/NC_DATA_LOGS.robot
...
Network Cloud NW model Creation for Control Plane - LOGS
...
#    ${VNF_SERVICE_DISTRIBUTION_DATA_01}    Set Variable    ${PAR_VNF_SERVICE_DISTRIBUTION_DATA_01}
    ...
    #New ***********************************************************************
     ...
     Login To Ecomp Portal
     Launch Application and Validate    VID
    ${VNF_SERVICE_INSTANCE_ID}    ${VNF_ID}    ${VNF_NAME}    ${VNF_TYPE}    VID_RESOURCE.VID VNF Creation       ${VNF_SERVICE_DISTRIBUTION_DATA_01}    #${SERVICE_NAME}  
#     ${VNF_DETAILS}    VID VNF Creation       b6e450b1-1911-4f39-bf44-ec2a156577c6
     ...
     Find Replace       ${EXECDIR}\\robot\\resources\\SDC\\SDC_DATA.robot     [\\$\\{]*VNF_SERVICE_INSTANCE_ID[${SPACE}a-zA-Z://0-9.\\-\\_\\[\\]\\=\\;\\'\\$\\{\\}]*     \$\{VNF_SERVICE_INSTANCE_ID\} ${SPACE}${SPACE}${SPACE} ${VNF_SERVICE_INSTANCE_ID}
     #
