...
@{Network_Excel_files}           mgt_vcscf.xlsm      imscore_vcscf.xlsm    imsli_vcscf.xlsm   
@{Vnf_Excel_files}       vnf_vcscf.xlsm
# @{vf_preload_files}    updated_vcscf_ssa.xlsm
${NUMBER_OF_ADDON_VF_MODULE}    0
...
TC#1_Network_Model_Creation
                               ...
                               Set VNF Variable     VCSCF
                               Log To Console       VNF model is set for VCSCF
                               ${NumModelsCount}    Evaluate                        ${VCSCF_NumModels}+1
...
TC#5_VNF_Preload_Upload
    ...
    Set Global Variable                 ${vnf}                                  VCSCF
    VF Preload upload                   ${Vnf_Excel_files}    
    
    
TC#6_VNF_Spinup
    Set Global Variable    ${GLOBAL_SELENIUM_BROWSER }    firefox
    Set Global Variable    ${GLOBAL_VNF}                  VCSCF
    VNF Creation           vnf
