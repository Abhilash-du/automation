...
@{Network_Excel_files}           int_apn-dns.xlsm    oam_protected_apn-dns.xlsm  #GRP-27529-T-SIL-13B_MGMT_APN-DNS0_net_11.xlsm   GRP-27529-T-SIL-13B_TRST_APN-DNS0_net_11.xlsm  GRP-27529-T-SIL-13B_UNTR_APN-DNS0_net_11.xlsm
@{Vnf_Excel_files}       GRP_27529_T_SIL_13B_MGMT_APN-DNS0_net_11.xlsm    # GRP_27529_T_SIL_13B_TRST_APN-DNS0_net_11.xlsm   GRP_27529_T_SIL_13B_UNTR_APN-DNS0_net_11.xlsm
@{vf_preload_files}    updated_APN-DNS_ssa_b_trial.xlsm      updated_APN-DNS_ssa_a_trial.xlsm        updated_APN-DNS_rtp_trial.xlsm
${NUMBER_OF_ADDON_VF_MODULE}    1
${NUMBER_OF_VOLUME_GROUPS}    1
${VNF_SERVICE_INSTANCE_ID}   NA
...
TC#1_Network_Model_Creation
                               ...
                               Set VNF Variable     APN-DNS
                               Log To Console       VNF model is set for APN-DNS
                               ${APN-DNS_NumModelsCount}    Evaluate                        ${APN-DNS_NumModels}+1
                               :FOR                 ${netItr}                       IN RANGE                                        1            ${APN-DNS_NumModelsCount}
...
TC#5_VNF_Preload_Upload
    ...
    Set Global Variable                 ${vnf}                                  APN-DNS
    VF Preload upload                   ${vf_preload_files}    
    
    
TC#6_VNF_Spinup
    Set Global Variable    ${GLOBAL_SELENIUM_BROWSER }    firefox
    Set Global Variable    ${GLOBAL_VNF}                  APN-DNS
    VNF Creation           vnf
