...
@{Network_Excel_files}           ha_vtfbc.xlsm      unused_vtfbc.xlsm 
@{Vnf_Excel_files}       vnf_vtfbc.xlsm
@{vf_preload_files}    updated_visbc_ssa_b_trial.xlsm
...
TC#1_Network_Model_Creation
                               ...
                               Set VNF Variable     VTFBC
                               Log To Console       VNF model is set for VTFBC
                               ${NumModelsCount}    Evaluate                        ${VTFBC_NumModels}+1
...
TC#5_VNF_Preload_Upload
    ...
    Set Global Variable                 ${vnf}                                  VTFBC
    VF Preload upload                   ${vf_preload_files}    
    
    
TC#6_VNF_Spinup
    Set Global Variable    ${GLOBAL_SELENIUM_BROWSER }    firefox
    Set Global Variable    ${GLOBAL_VNF}                  VTFBC
    VNF Creation           vnf
