...
@{Network_Excel_files}           mgmt_vcom_net_95.xlsm      #GRP-27529-T-SIL-13B_MGMT_VRSBG0_net_11.xlsm   GRP-27529-T-SIL-13B_TRST_VRSBG0_net_11.xlsm  GRP-27529-T-SIL-13B_UNTR_VRSBG0_net_11.xlsm
@{Vnf_Excel_files}       GRP_27529_T_SIL_13B_MGMT_VRSBG0_net_11.xlsm    GRP_27529_T_SIL_13B_TRST_VRSBG0_net_11.xlsm   GRP_27529_T_SIL_13B_UNTR_VRSBG0_net_11.xlsm
@{vf_preload_files}    updated_VRSBG_ssa_b_trial.xlsm      updated_VRSBG_ssa_a_trial.xlsm        updated_VRSBG_rtp_trial.xlsm
...
TC#1_Network_Model_Creation
                               ...
                               Set VNF Variable     VRSBG
                               Log To Console       VNF model is set for VRSBG
                               ${NumModelsCount}    Evaluate                        ${VRSBG_NumModels}+1
...
TC#5_VNF_Preload_Upload
    ...
    Set Global Variable                 ${vnf}                                  VRSBG
    VF Preload upload                   ${vf_preload_files}    
    
    
TC#6_VNF_Spinup
    Set Global Variable    ${GLOBAL_SELENIUM_BROWSER }    firefox
    Set Global Variable    ${GLOBAL_VNF}                  VRSBG
    VNF Creation           vnf
