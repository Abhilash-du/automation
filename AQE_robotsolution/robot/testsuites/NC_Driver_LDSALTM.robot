...
Resource         ../resources/NC/NC_DATA_LDSALTM.robot
...
# ${PRELOAD_TYPE}    
# ${PRELOAD_FILE_NAME}
# ${NUMBER_OF_ADDON_VF_MODULE}

#${NETWORK_COUNT_LOGS}    2
${NETWORK_COUNT_MCCD}    1
${VNF_TYPE}       MCCD     #LOGS
...
#     ${VNF_DETAILS}    VID VNF Creation       b6e450b1-1911-4f39-bf44-ec2a156577c6
     ...
     Find Replace       ${EXECDIR}\\robot\\testsuites\\NC_Driver_LOGS.robot     [\\$\\{]*VNF_SERVICE_INSTANCE_ID[${SPACE}a-zA-Z://0-9.\\-\\_\\[\\]\\=\\;\\'\\$\\{\\}]*     \$\{VNF_SERVICE_INSTANCE_ID\} ${SPACE}${SPACE}${SPACE} ${VNF_SERVICE_INSTANCE_ID}
     #
