...
@{Network_Excel_files}           rdm6actsf5003v_preload.xlsm      #GRP-27529-T-SIL-13B_MGMT_vCTS0_net_11.xlsm   GRP-27529-T-SIL-13B_TRST_vCTS0_net_11.xlsm  GRP-27529-T-SIL-13B_UNTR_vCTS0_net_11.xlsm
@{Vnf_Excel_files}       vCTS_VNF_preload.xlsm
@{vf_preload_files}    mgnt_vCTS.xlsm      sigV4_vCTS.xlsm        sigV6_vCTS.xlsm    dumv4_vCTS.xlsm
...
TC#1_Network_Model_Creation
                               ...
                               Set VNF Variable     vCTS
                               Log To Console       VNF model is set for vCTS
                               ${NumModelsCount}    Evaluate                        ${VCTS_NumModels}+1
...
TC#5_VNF_Preload_Upload
    ...
    Set Global Variable                 ${vnf}                                  vCTS
    VF Preload upload                   ${vf_preload_files}    
    
    
TC#6_VNF_Spinup
    Set Global Variable    ${GLOBAL_SELENIUM_BROWSER }    firefox
    Set Global Variable    ${GLOBAL_VNF}                  vCTS
    VNF Creation           vnf
