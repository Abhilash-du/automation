...
@{Network_Excel_files}           vLCMA_networkPreload.xlsm      #GRP-27529-T-SIL-13B_MGMT_VLCMA0_net_11.xlsm   GRP-27529-T-SIL-13B_TRST_VLCMA0_net_11.xlsm  GRP-27529-T-SIL-13B_UNTR_VLCMA0_net_11.xlsm
@{Vnf_Excel_files}       GRP_27529_T_SIL_13B_MGMT_VLCMA0_net_11.xlsm    GRP_27529_T_SIL_13B_TRST_VLCMA0_net_11.xlsm   GRP_27529_T_SIL_13B_UNTR_VLCMA0_net_11.xlsm
@{vf_preload_files}    updated_VLCMA_ssa_b_trial.xlsm      updated_VLCMA_ssa_a_trial.xlsm        updated_VLCMA_rtp_trial.xlsm
...
TC#1_Network_Model_Creation
                               ...
                               Set VNF Variable     VLCMA
                               Log To Console       VNF model is set for VLCMA
                               ${VLCMA_NumModelsCount}    Evaluate                        ${VLCMA_NumModels}+1
                               :FOR                 ${netItr}                       IN RANGE                                        1            ${VLCMA_NumModelsCount}
...
TC#5_VNF_Preload_Upload
    ...
    Set Global Variable                 ${vnf}                                  VLCMA
    VF Preload upload                   ${vf_preload_files}    
    
    
TC#6_VNF_Spinup
    Set Global Variable    ${GLOBAL_SELENIUM_BROWSER }    firefox
    Set Global Variable    ${GLOBAL_VNF}                  VLCMA
    VNF Creation           vnf
